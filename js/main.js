...
4. Preloader
5. Parallax Init
6. ULocker Control Top Menu Offset
7. ULocker Control Footer Menu Offset
8. ULocker Control Sync Slider
9. ULocker Control Video pop UP
10. ULocker Control Video Background
11. ULocker Control Welcome Slider
12. ULocker Control Accordion
13. Contact Form
...
18. Sticky Menu
18. 3D Slider
19.  ULocker Control - MENU TOGGLE INIT
20. ULocker Control - Parallax on mouseover
21. ULocker Control - V9 Screenshot
...
-------------------------------------------------------------------*/
  ...
  ================================================*/
    if (
      $(
        '.apps-craft-menu ul li a, .apps-craft-menu-item ul li a, .apps-craft-logo a',
      ).length > 0
    ) {
      $(
        '.apps-craft-menu ul li a:not(.apps-craft-login), .apps-craft-menu-item ul li a, .apps-craft-logo a',
    ...
    if ($('#apps-craft-commentor-slider').length > 0) {
      ...
      function syncPosition(el) {
        ...
        $('#apps-craft-testimonial-thumb')
          ...
          .addClass('synced');
        if (
          $('#apps-craft-testimonial-thumb').data('owlCarousel') !== undefined
        ) {
          center(current);
        }
      }
  ...
  ================================================*/
    ...
    } // ULocker Control Video Pop UP

    /*=============================================== 
      9.1 ULocker Control Log In pop UP
  ================================================*/
  ...
  ================================================*/
    ...
    if ($('#apps-craft-form').length > 0) {
      ...
      apps_craft_form.on('submit', function (e) {
        ...
        $(
          '.apps_craft_error, .apps-craft-success-message, .apps-craft-loader',
        ).remove();
        ...
        if (apps_craft_input_email.val() === '') {
          apps_craft_input_email
            .before(
              '<div class="apps_craft_error">Email Address Should not be emtpy.</div>',
            )
            .hide()
            .fadeIn();
          ...
          apps_craft_input_email
            .before(
              '<div class="apps_craft_error">Email Address Should be valid.</div>',
            )
            .hide()
            .fadeIn();
          apps_craft_input_email.addClass('apps_craft_input_error');
          ...
          apps_craft_input_message
            .before(
              '<div class="apps_craft_error">Message Should not be emtpy.</div>',
            )
            .hide()
            .fadeIn();
        ...
        if (apps_craft_error === false) {
          apps_craft_contact_btn
            .before(
              '<span class="apps-craft-loader apps-craft-loader1"></span>',
            )
            .hide()
            .fadeIn();
          $.ajax({
            ...
            success: function (result) {
              apps_craft_contact_btn
                .after(
                  '<div class="apps-craft-success-message">' +
                    result +
                    '</div>',
                )
                .hide()
...
--------------------------------------------------------------*/
  ...
  ================================================*/
    ...
    $('.apps-craft-menu-item ul li a, .apps-craft-logo a').on(
      'click',
      function (event) {
        if ($('.apps-craft-side-bar-menu').hasClass('active')) {
          $('.apps-craft-side-bar-menu').removeClass('active');
  ...
  if ($('#carousel').length > 0) {
    ...
    Carousel3D.prototype.modify = function () {
      ...
      this.panelSize =
        this.element[this.isHorizontal ? 'offsetWidth' : 'offsetHeight'];
